...
if(isset($_POST['precio_km_medicion']) && $_POST['precio_km_medicion'] > 0)								$precio_km_medicion = (int)$_POST['precio_km_medicion'];
$precio_km_montaje = 0;
if(isset($_POST['precio_km_montaje']) && $_POST['precio_km_montaje'] > 0)								$precio_km_montaje = (int)$_POST['precio_km_montaje'];
$precio_extras_1 = 0;
if(isset($_POST['precio_extras_1']) && $_POST['precio_extras_1'] > 0)								$precio_extras_1 = (int)$_POST['precio_extras_1'];
$precio_extras_2 = 0;
if(isset($_POST['precio_extras_2']) && $_POST['precio_extras_2'] > 0)								$precio_extras_2 = (int)$_POST['precio_extras_2'];
$precio_extras_3 = 0;
if(isset($_POST['precio_extras_3']) && $_POST['precio_extras_3'] > 0)								$precio_extras_3 = (int)$_POST['precio_extras_3'];
$precio_extras_4 = 0;
if(isset($_POST['precio_extras_4']) && $_POST['precio_extras_4'] > 0)								$precio_extras_4 = (int)$_POST['precio_extras_4'];
$precio_extras_5 = 0;
if(isset($_POST['precio_extras_5']) && $_POST['precio_extras_5'] > 0)								$precio_extras_5 = (int)$_POST['precio_extras_5'];
$precio_extras_6 = 0;
if(isset($_POST['precio_extras_6']) && $_POST['precio_extras_6'] > 0)								$precio_extras_6 = (int)$_POST['precio_extras_6'];
$precio_extras_7 = 0;
if(isset($_POST['precio_extras_7']) && $_POST['precio_extras_7'] > 0)								$precio_extras_7 = (int)$_POST['precio_extras_7'];
$precio_extras_8 = 0;
if(isset($_POST['precio_extras_8']) && $_POST['precio_extras_8'] > 0)								$precio_extras_8 = (int)$_POST['precio_extras_8'];
$precio_extras_9 = 0;
if(isset($_POST['precio_extras_9']) && $_POST['precio_extras_9'] > 0)								$precio_extras_9 = (int)$_POST['precio_extras_9'];
$precio_extras_10 = 0;
if(isset($_POST['precio_extras_10']) && $_POST['precio_extras_10'] > 0)								$precio_extras_10 = (int)$_POST['precio_extras_10'];
$precio_extras_11 = 0;
if(isset($_POST['precio_extras_11']) && $_POST['precio_extras_11'] > 0)								$precio_extras_11 = (int)$_POST['precio_extras_11'];
$precio_extras_12 = 0;
if(isset($_POST['precio_extras_12']) && $_POST['precio_extras_12'] > 0)								$precio_extras_12 = (int)$_POST['precio_extras_12'];
$precio_extras_13 = 0;
if(isset($_POST['precio_extras_13']) && $_POST['precio_extras_13'] > 0)								$precio_extras_13 = (int)$_POST['precio_extras_13'];

$precio_albanileria_sencilla = 0;
if(isset($_POST['precio_albanileria_sencilla']) && $_POST['precio_albanileria_sencilla'] > 0)								$precio_albanileria_sencilla = (int)$_POST['precio_albanileria_sencilla'];
$precio_albanileria_tirar_tabique = 0;
if(isset($_POST['precio_albanileria_tirar_tabique']) && $_POST['precio_albanileria_tirar_tabique'] > 0)								$precio_albanileria_tirar_tabique = (int)$_POST['precio_albanileria_tirar_tabique'];
$precio_albanileria_quitar_solera = 0;
if(isset($_POST['precio_albanileria_quitar_solera']) && $_POST['precio_albanileria_quitar_solera'] > 0)								$precio_albanileria_quitar_solera = (int)$_POST['precio_albanileria_quitar_solera'];
$precio_albanileria_mover_enchufe = 0;
if(isset($_POST['precio_albanileria_mover_enchufe']) && $_POST['precio_albanileria_mover_enchufe'] > 0)								$precio_albanileria_mover_enchufe = (int)$_POST['precio_albanileria_mover_enchufe'];
$precio_albanileria_costado_pladur = 0;
if(isset($_POST['precio_albanileria_costado_pladur']) && $_POST['precio_albanileria_costado_pladur'] > 0)								$precio_albanileria_costado_pladur = (int)$_POST['precio_albanileria_costado_pladur'];
$precio_leds_incrustados = 0;
if(isset($_POST['precio_leds_incrustados']) && $_POST['precio_leds_incrustados'] > 0)								$precio_leds_incrustados = (int)$_POST['precio_leds_incrustados'];
$precio_herrajes_negros = 0;
if(isset($_POST['precio_herrajes_negros']) && $_POST['precio_herrajes_negros'] > 0)								$precio_herrajes_negros = (int)$_POST['precio_herrajes_negros'];
$precio_multitaladro = 0;
if(isset($_POST['precio_multitaladro']) && $_POST['precio_multitaladro'] > 0)								$precio_multitaladro = (int)$_POST['precio_multitaladro'];
$precio_espejo_extraible = 0;
if(isset($_POST['precio_espejo_extraible']) && $_POST['precio_espejo_extraible'] > 0)								$precio_espejo_extraible = (int)$_POST['precio_espejo_extraible'];
$precio_espejo_carril = 0;
if(isset($_POST['precio_espejo_con_carril']) && $_POST['precio_espejo_con_carril'] > 0)								$precio_espejo_carril = (int)$_POST['precio_espejo_con_carril'];
$precio_baldas_inclinadas = 0;
if(isset($_POST['precio_baldas_inclinadas']) && $_POST['precio_baldas_inclinadas'] > 0)								$precio_baldas_incilnadas = (int)$_POST['precio_baldas_inclinadas'];
$precio_kit_plegable = 0;
if(isset($_POST['precio_kit_plegable']) && $_POST['precio_kit_plegable'] > 0)								$precio_kit_plegable = (int)$_POST['precio_kit_plegable'];
$precio_recrecer_frente = 0;
if(isset($_POST['precio_recrecer_frente']) && $_POST['precio_recrecer_frente'] > 0)								$precio_recrecer_frente = (int)$_POST['precio_recrecer_frente'];
...
$precio_desmontaje = 0;
if(isset($_POST['precio_desmontaje']) && $_POST['precio_desmontaje'] > 0)					$precio_desmontaje = (float)$_POST['precio_desmontaje'];
...
$fecha_proyecto = date('Y-m-d H:i:s');
$ip = "";
...
if($ok){ // SI TODO SE HA GUARDADO BIEN
	...
	$respuesta['estado'] = 'ko';
	$respuesta['mensaje'] = "Error al guardar el proyecto, intentelo de nuevo";
}

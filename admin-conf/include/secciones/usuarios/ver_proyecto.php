...
<div id="ver_proyecto" class="pantalla_completa">
	<div class="contenido">
		<div class="navegacion">
			<a class="boton gris grande" href="index.php?seccion=usuarios&sub=ver_usuario&id=<?php echo $proyecto['id_usuario']; ?>"><i class="fa fa-chevron-left"></i> Usuario</a>
		</div>
		<div class="titulo_superior">
			<?php echo $usuario; ?>
		</div>
		<div class="enviado_eliminado">
			<?php if($proyecto['enviado'] == 1){ ?>
			<div class="mensaje_verde">Proyecto enviado a fábrica: <?php echo date('d/m/Y H:i:s', strtotime($proyecto['fecha_enviado'])); ?></div>
			<?php }else{ ?>
			<div class="mensaje_naranja">Proyecto sin enviar a fábrica</div>
			<?php } ?>
			<?php if($proyecto['eliminado'] == 1){ ?>
			<div class="mensaje_rojo">Proyecto eliminado por el usuario: <?php echo date('d/m/Y H:i:s', strtotime($proyecto['fecha_eliminado'])); ?></div>
			<?php } ?>
		</div>
		<div class="vista_proyecto">
			...
			<div class="fila_proyecto">
				...
				<div class="item_fila_proyecto">
					...
					<?php if($perfileria){ echo $perfileria['nombre']; ?><br /><img src="../www/img/colores/<?php echo $perfileria['imagen']; ?>" title="<?php echo $perfileria['nombre']; ?>"> <?php }else{ echo "-"; } ?>
				</div>
				<div class="item_fila_proyecto">
			...
			<div class="fila_proyecto">
				...
				<?php if($proyecto['enviado'] == 1){ ?>
					<div class="boton_editar_proyecto">
						<a class="boton grande naranja" title="Editar proyecto" onClick="confirmar_editar_proyecto(<?php echo $id; ?>, 1);"><i class="fa fa-edit"></i> Editar proyecto</a>
					</div>
				<?php } ?>

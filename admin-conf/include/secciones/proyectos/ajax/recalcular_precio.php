...
if ($desmontaje_frente > 0) {
	...
	$precio_desmontaje_frente += $precio_desmontaje_frente * $_SESSION['pvp'] / 100;
} else {
...
if ($desmontaje_interior > 0) {
	...
	$precio_desmontaje_interior += $precio_desmontaje_interior * $_SESSION['pvp'] / 100;
} else {
...
if ($desmontaje_frente > 0 && $desmontaje_interior > 0) {
	...
	$precio_desmontaje += $precio_desmontaje * $_SESSION['pvp'] / 100;
	$precio_desmontaje_frente = 0;
	$precio_desmontaje_interior = 0;
}
...
if ($albanileria_con > 0) {
	...
	$precio_albanileria_con += $precio_albanileria_con * $_SESSION['pvp'] / 100;
} else {
...
if ($albanileria_sin > 0) {
	...
	$precio_albanileria_sin += $precio_albanileria_sin * $_SESSION['pvp'] / 100;
} else {
...
if ($extras_1 > 0) {
	...
	if($acabado == 4)
	{
		...
		$precio_extras_1 += $precio_extras_1 * $_SESSION['pvp'] / 100;
	}
} else {
	$precio_extras_1 = 0;
}
...
if ($extras_2 > 0) {
	...
	$precio_extras_2 += $precio_extras_2 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_2 = 0;
}
...
if ($extras_3 > 0) {
	...
	$precio_extras_3 += $precio_extras_3 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_3 = 0;
}
...
if ($extras_4 > 0) {
	...
	$precio_extras_4 += $precio_extras_4 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_4 = 0;
}
...
if ($extras_5 > 0) {
	...
	$precio_extras_5 += $precio_extras_5 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_5 = 0;
}
...
if ($extras_6 > 0) {
	...
	$precio_extras_6 += $precio_extras_6 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_6 = 0;
}
...
if ($extras_7 > 0) {
	...
	$precio_extras_7 += $precio_extras_7 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_7 = 0;
}
...
if ($extras_8 > 0) {
	...
	$precio_extras_8 += $precio_extras_8 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_8 = 0;
}
...
if ($extras_9 > 0) {
	...
	$precio_extras_9 += $precio_extras_9 * $_SESSION['pvp'] / 100;
} else {
	$precio_extras_9 = 0;
}
...
if ($albanileria_sencilla > 0) {
	...
	$precio_albanileria_sencilla += $precio_albanileria_sencilla * $_SESSION['pvp'] / 100;
} else {
...
if ($albanileria_tirar_tabique > 0) {
	...
	$precio_albanileria_tirar_tabique += $precio_albanileria_tirar_tabique * $_SESSION['pvp'] / 100;
} else {
...
if ($albanileria_quitar_solera > 0) {
	...
	$precio_albanileria_quitar_solera += $precio_albanileria_quitar_solera * $_SESSION['pvp'] / 100;
} else {
...
if ($albanileria_mover_enchufe > 0) {
	...
	$precio_albanileria_mover_enchufe += $precio_albanileria_mover_enchufe * $_SESSION['pvp'] / 100;
} else {
...
if ($albanileria_costado_pladur > 0) {
	...
	$precio_albanileria_costado_pladur += $precio_albanileria_costado_pladur * $_SESSION['pvp'] / 100;
} else {
...
// PLUS DARK GREY
$respuesta['plus_dark_grey'] = number_format($plus_dark_grey + $plus_dark_grey * $_SESSION['pvp'] / 100, 2, ".", "");

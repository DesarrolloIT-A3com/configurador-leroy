...
$respuesta['precio_modulos_interior'] = number_format(round($precio_modulos + $precio_modulos * $_SESSION['pvp'] / 100, 2),2,".","");

// PRECIO DE LOS ACCESORIOS DEL INTERIOR
$respuesta['precio_accesorios_interior'] = number_format(round($precio_accesorios + $precio_accesorios * $_SESSION['pvp'] / 100, 2),2,".","");
...
$respuesta['cant_incremento_descuento_interior'] = number_format(round($cant_incremento_descuento_interior  + $cant_incremento_descuento_interior * $_SESSION['pvp'] / 100, 2),2,".","");

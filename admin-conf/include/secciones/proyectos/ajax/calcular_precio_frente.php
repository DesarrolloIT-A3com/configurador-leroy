...
$respuesta = array();
// PRECIO DEL FRENTE
$respuesta['precio'] = number_format(round($precio + $precio * $_SESSION['pvp'] / 100, 2),2,".","");
// PRECIO DEL MONTAJE
...
$respuesta['cant_incremento_descuento'] = number_format(round($cant_incremento_descuento + $cant_incremento_descuento * $_SESSION['pvp'] / 100, 2),2,".","");
